"""
Django settings for snake_gamep_45004 project.
...
ROOT_URLCONF = 'snake_gamep_45004.urls'
...
WSGI_APPLICATION = 'snake_gamep_45004.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "snake_gamep_45004 API",
    "DESCRIPTION": "API documentation for snake_gamep_45004 App",
    "VERSION": "v1",
}
